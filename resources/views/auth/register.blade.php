<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="speciality" class="block mt-1 w-full" type="text" name="speciality" :value="old('speciality')" required autofocus autocomplete="speciality" />
        ...
        <!-- CMP -->
        <div>
            <x-input-label for="cmp" :value="__('Cmp')" />
            <x-text-input id="cmp" class="block mt-1 w-full" type="text" name="cmp" :value="old('cmp')" required autofocus autocomplete="cmp" />
            <x-input-error :messages="$errors->get('cmp')" class="mt-2" />
        </div>
