    ...
    <div class="d-flex justify-content-center">
        <form style="width: 100%; max-width: 600px;" action="{{ route('clinica.update', $historiaClinica->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea id="examenes_medicos" name="examenes_medicos" class="form-control" placeholder="Ingrese los examenes medicos" required>{{ $historiaClinica->examenes_medicos }}</textarea>
            </div>
